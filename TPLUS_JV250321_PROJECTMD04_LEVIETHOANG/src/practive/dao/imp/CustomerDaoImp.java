...
public class CustomerDaoImp implements CustomerDAO {
    ...
    public boolean updateCustomer(Customer customer) {
        ...
        try{
            conn = ConnectionDB.openConnection();
            callSt = conn.prepareCall("{call update_customer_by_id(?,?,?,?,?)}");
            callSt.setInt(1, customer.getCustomerId());
            callSt.setString(2, customer.getCustomerName());
            callSt.setString(3, customer.getCustomerPhone());
            callSt.setString(4, customer.getCustomerEmail());
            callSt.setString(5, customer.getCustomerAddress());
            callSt.executeUpdate();
            return true;
        }catch (Exception e){
            e.printStackTrace();
